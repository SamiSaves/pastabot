export default {
    karvatura: `Ilmeeni kun entinen koira kantoi aina karvatura koira kantoi sänkyyn kesällä hiekkaa kun makoili ja pyöri tarhassa jotka karisi sitten illalla sisälle kun otettiin koirat sisään.`,
    imppaus: `Ite oon impannut yhteensä varmaan kymmeniä tunteja ja oon 100% kunnossa vaikka oon impaanut varmaan 100 tuntiakin impannut`,
    hauskin: `Sieltä se tulee taas. Katsokaa kaikki! Hän postasi sen taas kerran! Eikö hän olekin koko laudan hauskin henkilö? Voi hyvä luoja!

    Voin kuvitella miten istut pimeässä huoneessa, ainonana valonlähteenäsi tietokoneen ruutu. Kikatat kuin pieni tyttö, kun teet taas kerran langan, mihin voit laittaa hienon trollausyrityksesi. Täytät captchan ja lähetät viestin. Tai ehkä et edes täytä captchaa. Ehkä olet oikeasti niin luuseri, että ostit kultatilin, jolloin vain liität trollailukansiosi helmen viestikenttään ja lähetät sen. Ja me kaikki tiedämme sen teeman. "AAH AAH AAAAHH", eikö vain? Voin kuvitella miten paljon naurat lähettäessäsi viestiä, niin että pudotat sipsusi lattialle, mutta se ei haittaa, koska äitisi käy siivoamassa huoneesi seuraavana päivänä. Niin tosiaan, unohdinko sanoa? Asut äitisi luona. Olet laiska paska ja hän on luultavasti kyllästynyt ainaiseen holhoamiseesi. Niin kyllästynyt aina tekemään kaiken aikuiselle miehelle, joka postaa trollauslankoja kaiket päivät satunnaiseen. Äitisi kuvitteli, että sinusta tulisi astronautti tai tiedemies, mutta rupesit työttömäksi rotaksi. trollauslankoja postaava rotta. Äitisi ei voi edes puhua sinulle, kun ainoa asia mitä osaat sanoa on "AAH AAH AAAAHH". Olet muuttunut parodiaksi omasta itsestäsi. Ja se on kaikki mitä tulet olemaan. Pieni, surullinen mies pimeässä huonessa postaamassa samaa teemaa päivästä toiseen. Ja se on kaikki mitä tulet olemaan.`,
    huutista: `Kun oon lueskellu tätä foorumia niin mua on aina ihmetyttäny tää tämmönen helvetinmoinen huutis, huutista huutista huutista... kaikennäkösille järkevillekin asioille tulee huutista miks pitää joka helvetin asialle tulla huutista Mun pitikin sanoa paljon törkeämpää tekstiä, mutta mä nyt siivosin tän ja niin edelleen mut on tää uskomatonta huutista, huutista joka helvetin asialle tulee huutista. Mitään hauskaa ei mul oo yhtään hauskaa kun ihan typerille asioille koko ajan tulee huutista. No huutista tulee joka ikiselle asialle eihän kukaan kestä lukee tämmöstä huutista`,
    proffa: `Minkälainen olisitte halunneet olla nuoruudessa jos nyt saisitte päättää? Minä tällainen:
    ...
    tykitys: `True Kakkofonic Tykitys Metallia ovat bändit kuten Sonata Arctica, Pathfinder, Fairyland, Stratovarius, Gamma Ray, Dragonland ja Angra. Sinä voit kuunnella Morbosidadiasi jos tahdot, mutta et ymmärrä todellisesta hevanderista yhtään mitään. Olet pelkkä poseri ja voit painua vittuun koko skenestä. Tykitys Metal on Todellista musiikkia, jota ei ole tarkoitettu sinunlaisillesi eläimille, vaan todellisille hevi äijille, jotka eivät piittaa sinunlaisistasi pelleistä. Tykitys Metal on eliitin musiikkia ja sinä et sitä ymmärrä. Kukaan teistä ei ymmärrä Todellista Kakkofoniaa. Olette naurettavia pikkulapsia. Maailmankuvamme perustuu tribaalismiin, henkilökohtaisella tasolla tuplabasarismiin, kollektiivisella tasolla falsetismiin. Ilman ymmärrystä susipaidoista, on turha haaveilla ymmärtävänsä tykittämisen maailmankuvaa. Teistä kukaan ei voi ymmärtää tykitystä, sillä olette kaikki älyllisesti kuin kastematoja. Te ette voi yltää elitistisen Kakkofonian tasolle, joten miksi edes haaveilette siitä. Sudet ja Tykitys Metal ovat eliitille. Todellisille hevi äijille.`,
    päärynä: `kerran heitettii päärynä vitun lujaa seinään (Juuso heitti ja se käy salilla) niin kuulu vaa poks eikä ollu edes mitään mössö tai mitn missää vaa se hävis kokonaan`,
    vessapaperi: `>ole 19 >muuta omaan kämppään vihdoin >viisi päivää muutosta >pyyhi persettäsi viimeisillä paperijämillä porukoilta saadusta rullasta >samalla tajua, että vessapaperi on nyt loppu eikä tietenkään itsemurhayksiöstä löydy pillupuhelinta >tajua hiljalleen, että seuraavaksi minun pitää ostaa vessapaperia >voi henkisesti pahoin

    Vedin tästä eteenpäin pari viikkoa siten, että joka kerta kun kävin paskalla niin kävin myös puoliksi suihkussa, että perseeni peseytyisi kunnolla. Mietin joka kerralla sitä samaa asiaa, eli miten se ensikerta oikeasti tulee menemään. Välillä jopa nukkumaan kun yritti mennä niin pyöri vain päässä sen kassatytyn nauru sekä skenaariot kuten esim se, että viivakoodi mysteerisesti ei toimi sen vessapaperin kohdalla, sillä hetkellä sattuu olemaan juuri kiireistä ja sitten se joutuu räpläämään sitä vessapaperin viivakoodia erikseen, samalla kun takana on tietenkin lauma paikallisen lukion tytyjä. Tämän tyyppisiä skenaarioita pyöri aina toisinaan päässäni eikä niistä päässyt eroon. 
